        ...
        sidebarMenu(
          ...
          menuItem("Image-level", startExpanded = TRUE, icon = icon("camera"),
            menuItem("Basic controls",
                    ...
                    fluidRow(column(2, 
                                    style=c("margin-top:25px;margin-right:0px"), 
                                    checkboxInput(inputId = "view2", label = NULL, value = FALSE, width = "1000px")), 
                             column(10, 
                                    style= "margin-left:0px",
                    ...
                    fluidRow(column(2, 
                                    style=c("margin-top:25px;margin-right:0px"), 
                                    checkboxInput(inputId = "view3", label = NULL, value = FALSE, width = "1000px")), 
                             column(10, 
                                    style= "margin-left:0px",
                    ...
                    fluidRow(column(2, 
                                    style=c("margin-top:25px;margin-right:0px"), 
                                    checkboxInput(inputId = "view4", label = NULL, value = FALSE, width = "1000px")), 
                             column(10, 
                                    style= "margin-left:0px",
                    ...
                    fluidRow(column(2, 
                                    style=c("margin-top:25px;margin-right:0px"), 
                                    checkboxInput(inputId = "view5", label = NULL, value = FALSE, width = "1000px")), 
                             column(10, 
                                    style= "margin-left:0px",
                    ...
                    fluidRow(column(2, 
                                    style=c("margin-top:25px;margin-right:0px"), 
                                    checkboxInput(inputId = "view6", label = NULL, value = FALSE, width = "1000px")), 
                             column(10, 
                                    style= "margin-left:0px",
